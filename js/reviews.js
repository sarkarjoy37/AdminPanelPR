...
async function deleteReview(reviewId) {
    try {
        ...
        // Add this line to show success message
        showMessage('Review deleted successfully!', 'success');
        fetchAndRenderReviews();
    } catch (error) {
        // Add this line to show error message
...
function showMessage(message, type) {
    ...
    // Insert after header or at the top of the content
    const header = document.querySelector('h1') || document.querySelector('.main-content');
